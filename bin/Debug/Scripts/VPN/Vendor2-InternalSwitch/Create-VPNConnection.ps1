...
#cd "Scripts\VPN\Vendor2-InternalSwitch\"

$files = @("Scripts\VPN\Vendor2-InternalSwitch\nircmd.exe", "Scripts\VPN\Vendor2-InternalSwitch\ras.bat", "Scripts\VPN\Vendor2-InternalSwitch\ras2.bat", "Scripts\VPN\Vendor2-InternalSwitch\rset.bat", "Scripts\VPN\Vendor2-InternalSwitch\rset.xml", "Scripts\VPN\Vendor2-InternalSwitch\VPNSTART1.xml", "Scripts\VPN\Vendor2-InternalSwitch\Create-VPNConnection.ps1")
